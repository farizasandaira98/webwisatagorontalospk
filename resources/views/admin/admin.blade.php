...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Halaman Admin || Aplikasi Sistem Pendukung Keputusan Pemilihan Obyek Wisata Dikota Gorontalo</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Admin -->
          <li class="nav-item">
             <a href="/admin/tempatwisata" class="nav-link">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h5 class="m-0" style="font-weight:10;">Sistem Pendukung Keputusan Pemilihan Obyek Wisata Dikota Gorontalo </h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{$sumtotaltempatwisata}}</h3>
                <p>Total Tempat Wisata</p>
              </div>
              <div class="icon">
                <i class="fas fa-building"></i>
              </div>
              <a href="/admin/tempatwisata" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
      </div><!-- /.container-fluid -->
...
var msg  = "Halaman Admin || Aplikasi Sistem Pendukung Keputusan Pemilihan Obyek Wisata Dikota Gorontalo";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
