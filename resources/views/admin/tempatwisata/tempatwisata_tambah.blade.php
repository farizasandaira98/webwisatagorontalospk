    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Tempat Wisata - <strong>TAMBAH DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/admin/tempatwisata/store" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Maks Jumlah Orang Yang Dapat Ditampung (Input Dalam Angka)</label>
              ...
              <div class="form-group">
                  <label>Luas Tempat Wisata (Input Dalam Angka Kilometer)</label>
                  <input type="text" class="form-control" id="luas_tempat_wisata"
                  name="luas_tempat_wisata">
              </input>
            ...
            <div class="form-group">
                ...
                <textarea name="wahana" class="form-control" placeholder="Wahana...."></textarea>
...
var msg  = "Tambah Tempat Wisata || Aplikasi Sistem Pendukung Keputusan Pemilihan Obyek Wisata Dikota Gorontalo";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
