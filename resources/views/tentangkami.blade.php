	...
	<div class="gtco-section">
		<div class="gtco-container">
          ...
          @if(Session::has('status'))
                ...
                <h5>Moh. Rifly Hidayat Mundung</5>
							</div>
						</div>
            ...
            <iframe src="{{asset('assets/images/fotoprofil.jpeg')}}" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div>
          <div class="gtco-contact-info">
          </div>
				</div>
