                      ...
                      <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="col-sm-4">
                            <div class="post-thumbnail">
                                <img src="{{asset('/foto_tempat_wisata/'.$ang->foto) }}" class="img-responsive img-thumbnail">
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-8">
                          <h3 class="title">
                            <a href="/tempatwisata/{{$ang->id}}" title="Judul">
                            {{$ang->nama_tempat_wisata}}</a>
                            </h3>
                            <small class="text-muted">
                              <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                              Diupload Pada  : {{$ang->created_at}}<p style="margin-top: 5px">
                              </small>
                              <hr style="m
                              argin: 10px 0">
                              <p class="post-read">
                              ...
                              <p class="text-muted hidden-xs">
                                <a href="/tempatwisata/{{$ang->id}}" class="btn btn-primary">Baca Selengkapnya <i class="fa fa-plus" aria-hidden="true"></i></a>
                              </p>
                            </div>
                          </div>
                          <hr>
